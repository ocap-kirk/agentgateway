...
impl From<CreateChatCompletionRequest> for Request {
	fn from(sdk: CreateChatCompletionRequest) -> Self {
		#[allow(deprecated)]
		Request {
			messages: sdk.messages,
			model: Some(sdk.model),
			store: sdk.store,
			reasoning_effort: sdk.reasoning_effort,
			metadata: sdk.metadata,
			frequency_penalty: sdk.frequency_penalty,
			logit_bias: sdk.logit_bias,
			logprobs: sdk.logprobs,
			top_logprobs: sdk.top_logprobs,
			max_tokens: sdk.max_tokens,
			max_completion_tokens: sdk.max_completion_tokens,
			n: sdk.n,
			modalities: sdk.modalities,
			prediction: sdk.prediction,
			audio: sdk.audio,
			presence_penalty: sdk.presence_penalty,
			response_format: sdk.response_format,
			seed: sdk.seed,
			service_tier: sdk.service_tier,
			stop: sdk.stop,
			stream: sdk.stream,
			stream_options: sdk.stream_options,
			temperature: sdk.temperature,
			top_p: sdk.top_p,
			tools: sdk.tools,
			tool_choice: sdk.tool_choice,
			parallel_tool_calls: sdk.parallel_tool_calls,
			user: sdk.user,
			web_search_options: sdk.web_search_options,
			function_call: sdk.function_call,
